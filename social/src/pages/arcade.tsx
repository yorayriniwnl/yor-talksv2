...
import { CyberKhurchan } from '@/components/games/CyberKhurchan';
import { CyberKesarGujiya } from '@/components/games/CyberKesarGujiya';
import { CyberKashmiriPhirni } from '@/components/games/CyberKashmiriPhirni';
    ...
    <div className="min-h-screen bg-background pb-24 font-sans text-foreground">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-6 space-y-8">
        ...
        <div className="flex gap-2 p-1.5 rounded-2xl surface-1 border border-border/40 w-fit mx-auto flex-wrap justify-center">
          ...
          <Button
            size="sm"
            variant={activeGame === 'mathura-khurchan' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('mathura-khurchan');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'mathura-khurchan' && "bg-gradient-to-r from-amber-600 via-orange-500 to-amber-300 text-black shadow-md")}
          >
            👑 Shahi Khurchan
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'braj-kesar-gujiya' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('braj-kesar-gujiya');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'braj-kesar-gujiya' && "bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-400 text-black shadow-md")}
          >
            👑 Kesar Gujiya
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'kashmiri-shahi-phirni' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('kashmiri-shahi-phirni');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'kashmiri-shahi-phirni' && "bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black shadow-md")}
          >
            👑 Kashmiri Phirni
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'mewari-dilkhushak' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('mewari-dilkhushak');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'mewari-dilkhushak' && "bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-700 text-black shadow-md")}
          >
            👑 Shahi Dilkhushak
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'mewari-gulab-paak' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('mewari-gulab-paak');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'mewari-gulab-paak' && "bg-gradient-to-r from-pink-500 via-rose-500 to-amber-400 text-white shadow-md")}
          >
            👑 Gulab Paak
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'jodhpuri-mawa-kachori' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('jodhpuri-mawa-kachori');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'jodhpuri-mawa-kachori' && "bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-600 text-black shadow-md")}
          >
            👑 Mawa Kachori
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'awadhi-paan-peda' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('awadhi-paan-peda');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'awadhi-paan-peda' && "bg-gradient-to-r from-emerald-500 via-teal-500 to-rose-500 text-white shadow-md")}
          >
            👑 Paan Peda
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'bikaneri-gulkand-peda' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('bikaneri-gulkand-peda');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'bikaneri-gulkand-peda' && "bg-gradient-to-r from-amber-500 via-rose-500 to-amber-600 text-white shadow-md")}
          >
            👑 Gulkand Peda
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'braj-kesar-malai-peda' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('braj-kesar-malai-peda');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'braj-kesar-malai-peda' && "bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black shadow-md")}
          >
            👑 Kesar Peda
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'awadhi-gulab-paan-gilori' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('awadhi-gulab-paan-gilori');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'awadhi-gulab-paan-gilori' && "bg-gradient-to-r from-rose-500 via-pink-500 to-emerald-500 text-white shadow-md")}
          >
            👑 Paan Gilori
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'bengali-kesar-sandesh-royal' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('bengali-kesar-sandesh-royal');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'bengali-kesar-sandesh-royal' && "bg-gradient-to-r from-yellow-400 via-amber-500 to-amber-600 text-black shadow-md")}
          >
            👑 Kesar Sandesh
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'bengali-kesar-chum-chum-royal' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('bengali-kesar-chum-chum-royal');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'bengali-kesar-chum-chum-royal' && "bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black shadow-md")}
          >
            👑 Chum Chum
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'mewari-kaju-gulkand-barfi' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('mewari-kaju-gulkand-barfi');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'mewari-kaju-gulkand-barfi' && "bg-gradient-to-r from-rose-500 via-pink-500 to-amber-400 text-white shadow-md")}
          >
            👑 Kaju Gulkand
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'pushkar-shahi-malpua-rabdi' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('pushkar-shahi-malpua-rabdi');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'pushkar-shahi-malpua-rabdi' && "bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-400 text-black shadow-md")}
          >
            👑 Malpua Rabdi
          </Button>
          ...
          <Button
            size="sm"
            variant={activeGame === 'mewari-shahi-moong-halwa' ? 'default' : 'ghost'}
            onClick={() => {
              sounds.playPop();
              setActiveGame('mewari-shahi-moong-halwa');
            }}
            className={cn("rounded-xl font-bold text-xs px-2.5 h-10", activeGame === 'mewari-shahi-moong-halwa' && "bg-gradient-to-r from-amber-400 via-yellow-300 to-orange-400 text-black shadow-md")}
          >
            👑 Moong Dal Halwa
          </Button>
        </div>
        ...
        <div>
          ...
          {activeGame === 'mathura-khurchan' && <CyberKhurchan />}
          {activeGame === 'braj-kesar-gujiya' && <CyberKesarGujiya />}
          {activeGame === 'kashmiri-shahi-phirni' && <CyberKashmiriPhirni />}
          ...
          {activeGame === 'pushkar-shahi-malpua-rabdi' && <CyberMalpuaRabdiRoyal />}
          {activeGame === 'mewari-shahi-moong-halwa' && <CyberMoongHalwaRoyal />}
        </div>
