...
const PROFILE_TRACKS = [
  'Cyberpunk Synthwave Lofi · AI & Spatial',
  '174 BPM Tokyo Drum & Bass · Esports & Gaming',
  '39-String Sitar Raga Fusion · Indian Classical',
  'Modular Berlin 138 BPM Techno · Eurorack',
  'Nürburgring 9,800 RPM Symphony · Motorsports',
  'Zen Garden Kyoto Bamboo Rain · Tea & Crafts',
  'Carina Deep Space Ambient Drone · Deep Science'
];
...
export function ProfileMusicPlayer() {
  ...
  const nextTrack = () => {
    sounds.playPop();
    setTrackIndex((prev) => (prev + 1) % PROFILE_TRACKS.length);
    if (!isPlaying) setIsPlaying(true);
  };

  const activeTrack = PROFILE_TRACKS[trackIndex];
