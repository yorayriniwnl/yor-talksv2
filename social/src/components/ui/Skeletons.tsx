...
export function ProfileSkeleton() {
  return (
    <div role="status" className="min-h-screen bg-background" aria-busy="true" aria-label="Loading profile">
      {/* Cover */}
...
export function MessagesSkeleton() {
  return (
    <div role="status" className="flex h-screen" aria-busy="true" aria-label="Loading messages">
      {/* Conversation list */}
