...
export function AppShell({ children }: AppShellProps) {
  ...
  const navItems = [
    ...
    { icon: Filter, label: 'MPO Shadow SVD Purification', path: '/mpo-shadow-purification' },
    { icon: Flame, label: 'HD-MIF Staged Fusion Cruiser', path: '/hdmif-fusion-cruiser' },
    ...
    { icon: Thermometer, label: 'MPDO Gradient Purifier QEM', path: '/mpdo-gradient-qem' },
    { icon: Flame, label: 'CBT Fusion Dreadnought', path: '/cbt-fusion-dreadnought' },
    ...
    { icon: Atom, label: 'fPEPS Grassmann Purifier QEM', path: '/fpeps-grassmann-qem' },
    { icon: Flame, label: 'Helicon Spheromak Merger Drive', path: '/helicon-spheromak-merger' },
    { icon: Repeat, label: 'CRISPR-Cas12ζ Chromosome Circularizer', path: '/cas12zeta-circularizer' },
    { icon: Radar, label: 'TIE Scout Deep Hyperspace Recon', path: '/tie-scout-skirmish' },
    { icon: Thermometer, label: 'Fracton Gravitational Anomaly', path: '/fracton-gravitational-anomaly' },
    { icon: Atom, label: 'GfPEPS High-Tc Purifier QEM', path: '/gfpeps-purifier-qem' },
    { icon: Flame, label: 'Liquid-Metal Liner Dreadnought', path: '/liquid-metal-liner-dreadnought' },
    ...
    { icon: Atom, label: 'iPEPDO Dissipative QEM', path: '/ipepdo-purifier-qem' },
    { icon: Flame, label: 'Tandem Mirror-Cusp Battlecruiser', path: '/mirror-cusp-battlecruiser' },
    ...
    { icon: Triangle, label: 'iTT-PESKCO Choi QEM', path: '/itt-peskco-purifier-qem' },
    { icon: Flame, label: 'Helical-Cusp Star-Dreadnought', path: '/helical-cusp-dreadnought' },
    { icon: DoorClosed, label: 'CRISPR-Cas12τ Insulator Gate', path: '/cas12tau-gate' },
    { icon: Bomb, label: 'TIE Plasma Siege Interceptor', path: '/tie-plasma-siege-interceptor' },
    { icon: Network, label: 'Fracton Braid Networks', path: '/fracton-braid-networks' },
    { icon: Triangle, label: 'iTT-PESCKS Resolvent QEM', path: '/itt-pescks-purifier-qem' },
    { icon: Flame, label: 'Helicon-FRC Mirror Cruiser', path: '/helicon-frc-mirror' },
